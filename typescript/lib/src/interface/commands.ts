...
export namespace commands {
    ...
    export type log = p_.Command<null, d_stream_log.Parameters>
    export type log_error = p_.Command<null, d_stream_log_error.Parameters>
    export type write_to_stderr = p_.Command<null, d_stream_write_to_stderr.Parameters>
    export type write_to_stdout = p_.Command<null, d_stream_write_to_stdout.Parameters>
